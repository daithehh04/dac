...
function Banner() {
  ...
  return (
    <div className='banner relative'>
      <Image src={dataBanner.background || imgBanner} alt="banner" quality={100} width={1000} height={1000} className="md:w-full md:h-[100vh] h-[100rem] rounded-br-[16rem] md:rounded-br-[13.54rem] object-cover" />
      <div className="flex flex-col justify-center h-full content">
        <div className='flex items-center absolute justify-end md:top-[50%] md:right-[4.58rem] max-md:left-[4.8rem] max-md:bottom-[13.27rem]'>
          {dataBanner?.id && <h2><Image src={imgTitle} width={'100%'} height={'100%'} alt='img' className='max-md:w-[68rem] max-md:h-[13.93467rem]' /></h2>}
        </div>
      </div>
