...
function Banner() {
  ...
  return (
    <div className='banner relative'>
      <Image src={context.dataBanner.background || imgBanner} alt="banner" quality={100} width={1000} height={1000} className="md:w-full md:h-[100vh] h-[100rem] rounded-br-[16rem] md:rounded-br-[13.54rem] object-cover" />
