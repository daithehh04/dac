      ...
      <div className='flex max-md:flex-col gap-x-[7.68rem] pt-[6.82rem] pb-[5.9rem] border-b border-solid border-[#444]'>
        ...
        <div className="right">
          ...
          <div className='flex gap-x-[5.42rem] md:mt-[2.86rem] mt-[10.56rem] max-md:flex-col max-md:px-[4.27rem]'>
            <p className='md:text-[1.5rem] lg:text-[1.35417rem] text-[4.26667rem] text-justify text-[#444] leading-[1.2] max-md:mb-[10.56rem]' dangerouslySetInnerHTML={{ __html: `${data?.subdescription1}` }}></p>
            <p className='md:text-[1.5rem] lg:text-[1.35417rem] text-[4.26667rem] text-justify text-[#444] leading-[1.2]' dangerouslySetInnerHTML={{ __html: `${data?.subdescription2}` }}></p>
          </div>
        </div>
      </div>
    </div>
