    ...
    return (
        <section>
            ...
            <div className="md:px-[12.03rem] flex md:pt-[5.89rem] pt-[9.33rem] md:pb-[7.97rem] justify-between max-md:flex-col px-[4.27rem]">
                ...
                <p className='text-[#444] max-md:mt-[4rem] max-md:mb-[12rem] md:w-[34.5625rem] text-justify md:h-[16.4375rem] text-ellipsis md:line-clamp-[8] md:text-[1.625rem] text-[4.26667rem] md:leading-[1.2] md:tracking-[-0.0325rem]'>
            ...
            <div className='md:h-[100vh] flex max-md:flex-col'>
                ...
                <div className='md:w-[50%]'>
                    <Image src={img1} alt='img' priority quality={100} className='md:w-full object-cover md:h-full h-[100rem]' />
                </div>
            </div>
