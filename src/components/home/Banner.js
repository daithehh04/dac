...
function Banner({ lang, dataBanner }) {
  ...
  return (
    <>
      <section className='banner relative md:w-full md:h-[160vw] h-[120rem] max-md:flex flex-col justify-center items-center frame'>
        ...
        <div className='flex max-md:hidden items-center sticky top-0 md:h-[100vh] justify-between content border-b border-solid border-[#888] max-md:flex-col'>
          ...
          <div className='flex max-md:flex-row-reverse items-center'>
            <h2 className='text-[3.4375rem] leading-[1.2] font-bold w-[25rem] text-end'>{dataBanner?.textfeature}</h2>
            <svg xmlns="http://www.w3.org/2000/svg" className='md:w-[5.96302rem] md:h-[7.69896rem]' viewBox="0 0 115 149" fill="none">
      ...
      <div className='border-b border-solid border-[#888] md:hidden mx-[4.27rem]'></div>
    </>
  )
}
