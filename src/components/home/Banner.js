  ...
  return (
    <div className='banner relative md:w-full md:h-[100vh]'>
      ...
      <div className="flex flex-col justify-center h-full content border-b border-solid border-[#888]">
        ...
        <p className='uppercase md:text-[1.8rem] lg:text-[1.25rem] text-[3.36rem] font-bold text-[#444] max-md:mt-[2.46rem] max-md:mb-[5.9rem] max-md:text-center'>KHÁCH HÀNG LUÔN LUÔN ĐÚNG</p>
      </div>
    </div>
  )
}
