...
function Product({ lang, dataProduct, dataProductList }) {
  ...
  return (
    <div className='product md:h-[56.25rem] flex md:mt-[4.11rem] max-md:mt-[9rem] max-md:flex-col'>
      <div className='md:w-[24rem] md:text-[3.4375rem] leading-[116.662%] md:tracking-[-0.17188rem] max-md:px-[4.27rem] md:bg-[#444] flex flex-col justify-between md:text-white pb-[9rem] md:pt-[7rem] md:pb-[2.88rem] md:pl-[3.91rem]'>
