...
function Product() {
    ...
    return (
        <section>
            <div className='md:pt-[5.1rem] md:pl-[11.67rem] md:pr-[12.03rem] md:pb-[6.56rem] flex justify-between'>
                <h2 className='heading md:w-[45.5rem]'>Sản phẩm dịch vụ</h2>
                <div className='flex flex-col md:w-[28.80208rem] md:text-[1.35417rem] leading-[1.2] md:tracking-[-0.09479rem] text-[#444] '>
                    ...
                    <ul className='flex flex-col pl-[2.5rem]'>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className='md:w-[2.60417rem] md:h-[2.23958rem] md:mt-[0.42rem]' viewBox="0 0 43 50" fill="none">
