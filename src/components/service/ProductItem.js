...
function ProductItem({ image, text }) {
    return (
        <div className='relative'>
            ...
            <p className='absolute z-[1] max-md:right-[4.27rem] bottom-[4rem] md:bottom-[2.86rem] md:left-[2.34rem] left-[4.8rem] md:right-[3.85rem] md:w-[14.79167rem] text-[#fff] font-bold md:text-[1.875rem] text-[6.93333rem] md:leading-[116.662%] md:tracking-[-0.05625rem] md:line-clamp-2 md:h-[4.9rem]'>{text}</p>
        </div>
    )
}
