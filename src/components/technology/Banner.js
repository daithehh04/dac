...
function Banner() {
    ...
    return (
        <div className='banner w-full md:h-[100vh] h-[100rem] relative '>
            ...
            <Image src={dataBanner?.background || imgBanner} quality={100} alt='banner' fill className='w-full md:rounded-br-[13.54rem] rounded-br-[16rem] h-full object-cover z-[0]' />
            <div className='flex flex-col justify-end absolute md:right-[14.17rem] md:bottom-[5.9rem] bottom-[3.73rem] max-md:left-[4.27rem]'>
                <h2 className='md:w-[30.3125rem] w-[49rem] text-[#fff] md:text-[3.4375rem] text-[8.53333rem] font-bold md:leading-[116.662%]'>{dataBanner?.text || 'Công nghệ in Offset'}</h2>
                <svg xmlns="http://www.w3.org/2000/svg" className='md:mt-[2rem] md:w-[2.67969rem] md:h-[2.23958rem] w-[6.66667rem] h-[5.86667rem]' viewBox="0 0 43 50" fill="none">
