        ...
        <>
            <div className='banner w-full md:h-[70vh] lg:h-[100vh] h-[100rem] relative '>
                ...
                <div className='flex flex-col justify-end absolute md:right-[14.17rem] md:bottom-[5.9rem] bottom-[3.73rem] max-md:left-[4.27rem]'>
                    <h2 className='md:w-[30.3125rem] w-[53rem] text-[#fff] md:text-[3.4375rem] text-[8.53333rem] font-bold md:leading-[116.662%]'>{context.dataBanner?.text || 'Công nghệ in Offset'}</h2>
                    <svg xmlns="http://www.w3.org/2000/svg" onClick={() => scrollDown(scrollDownRef, 'start')} className='md:mt-[2rem] md:w-[2.67969rem] md:h-[2.23958rem] w-[6.66667rem] h-[5.86667rem]' viewBox="0 0 43 50" fill="none">
