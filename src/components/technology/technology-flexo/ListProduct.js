...
function ListProduct({dataProductList}) {
    return (
        <section className='md:pt-[6.04rem] pt-[4.27rem] max-md:px-[4.27rem] flex md:px-[12.03rem] md:pb-[6.35rem] max-md:flex-col'>
            <Image src={img1} alt='image' quality={100} width={1000} height={1000} className='md:w-[36.66667rem] md:h-[22.1875rem] h-[55rem] md:hidden mb-[7.47rem] object-cover md:mb-[1.93rem]' />
