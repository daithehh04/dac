        ...
        <section className='md:pt-[5.05rem]  md:px-[12.03rem] md:pb-[9.03rem]'>
            <div className='flex'>
                ...
                <div className='flex flex-col'>
                    <Image src='https://cms-dac.okhub.tech/wp-content/uploads/2023/11/Rectangle-86.png' quality={100} width={1000} height={1000} className='md:w-full md:h-[22.1875rem] object-contain' />
